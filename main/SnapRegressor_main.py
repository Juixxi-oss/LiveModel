...
from trainer.SnapRegressorTrainer import SnapRegressorTrainer
from util import getAllTransforms


def parse_args():
    parser = argparse.ArgumentParser(description='Train SnapRegressor.')
    ...
    parser.add_argument('--result_root', type=str, default='file/SnapRegressor')
...
def main():
    ...
    save_model_path = os.path.join(
        ...
        name,
        'model',
        f'SnapRegressor_{name}_{args.grade_type}_photo{args.photo_type}_'
    )
    default_model_path = os.path.join(
        args.result_root,
        name,
        'model',
        f'SnapRegressor_{name}_{args.grade_type}_photo{args.photo_type}_default.pt'
    )
