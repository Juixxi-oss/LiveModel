...
from trainer.MultiViewTimeFusionRegressorTrainer import MultiViewTimeFusionRegressorTrainer
from util import getAllTransforms


def parse_args():
    parser = argparse.ArgumentParser(description='Train MultiViewTimeFusionRegressor.')
    ...
    parser.add_argument('--result_root', type=str, default='file/MultiViewTimeFusionRegressor')
...
def main():
    ...
    save_model_path = os.path.join(
        ...
        name,
        'model',
        f'MultiViewTimeFusionRegressor_'
        f'{args.task_type}_{name}_{args.grade_type}_'
    )
    ...
    default_model_path = os.path.join(
        ...
        'model',
        f'MultiViewTimeFusionRegressor_'
        f'{args.task_type}_{name}_{args.grade_type}_default.pt'
    )
    ...
    trainer = MultiViewTimeFusionRegressorTrainer(
        model=model,
